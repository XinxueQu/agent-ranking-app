...
def load_data():
    ...
    url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vTbCPKp_HwYtE22RjOJLJOvsoGlWWwJ_CJp7Thx41cRiV_pggfzIDBIISmcVC_csSfS3Jlkje_rsst0/export?format=csv&gid=0" 
    usecols = [
