...
def load_data():
    ...
    url = "https://docs.google.com/spreadsheets/d/16Po07qzp0k-OXdzW0MmWJz2qqTAW4fmJ/edit?usp=sharing&ouid=104528609416313763019&rtpof=true&sd=true/export?format=csv" 
    usecols = [
